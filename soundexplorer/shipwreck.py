...
class ShipWreck:
    ...
    def get_shipwreck_information_df(self, df):
        ...
        geotrackpoints = geopandas.GeoDataFrame(dfs, geometry=geopandas.points_from_xy(
            x=dfs['features/geometry/coordinates/0'], y=dfs['features/geometry/coordinates/1']),
                                                crs='EPSG:4326')
